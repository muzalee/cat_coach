...
Offset getOffset(MultiTweenValues<AniProps> animation) {
...
class FadeIn extends StatelessWidget {
  ...
  const FadeIn(
      {Key? key, this.delay = 0,
        this.child,
        this.fade = true,
        this.control = CustomAnimationControl.play,
        this.curve = Curves.ease}) : super(key: key);
